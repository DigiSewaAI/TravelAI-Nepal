...
class LocationSeeder extends Seeder
{
    public function run(): void
    {
        $locations = [
            ...
            ['country' => 'Nepal', 'state' => 'Sindhupalchok', 'city' => 'Sundarijal', 'latitude' => 28.0821, 'longitude' => 85.4243],
            ['country' => 'Nepal', 'state' => 'Sindhupalchok', 'city' => 'Chisapani', 'latitude' => 28.1356, 'longitude' => 85.4283],
            ['country' => 'Nepal', 'state' => 'Sindhupalchok', 'city' => 'Melamchi', 'latitude' => 28.0456, 'longitude' => 85.4987],
            ...
            ['country' => 'Nepal', 'state' => 'Baglung', 'city' => 'Baglung', 'latitude' => 28.3123, 'longitude' => 83.6123],
        ...
        $this->command->info('✅ Locations seeded: ' . count($locations) . ' records.');
    }
}