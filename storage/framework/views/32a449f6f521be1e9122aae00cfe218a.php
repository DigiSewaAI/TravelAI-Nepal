<?php $__env->startSection('title', __('messages.plan_entire') . ' ' . __('messages.nepal_journey')); ?>
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 class="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight text-gray-900">
            <?php echo e(__('messages.plan_entire')); ?> <span class="text-blue-600"><?php echo e(__('messages.nepal_journey')); ?></span>
          </h1>
          <p class="text-gray-600 text-lg md:text-xl mt-6 max-w-xl leading-relaxed">
            <?php echo e(__('messages.home_subtitle')); ?>

          </p>
          <div class="flex flex-wrap gap-4 mt-8">
            <a href="<?php echo e(route('public.services.index')); ?>" class="bg-gray-900 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-md hover:shadow-xl flex items-center gap-2"><i class="fas fa-map-marked-alt"></i> <?php echo e(__('messages.explore_trips')); ?></a>
            <a href="<?php echo e(route('register')); ?>" class="border border-gray-300 hover:border-blue-400 bg-white text-gray-800 font-semibold px-6 py-3 rounded-xl transition-all hover:bg-gray-50 flex items-center gap-2"><i class="fas fa-handshake"></i> <?php echo e(__('messages.become_partner_btn')); ?></a>
          </div>
          <div class="flex flex-wrap gap-6 mt-10 text-sm text-gray-500">
            <div class="flex items-center gap-1"><i class="fas fa-check-circle text-green-500"></i> <?php echo e(__('messages.no_hidden_fees')); ?></div>
            <div class="flex items-center gap-1"><i class="fas fa-shield-alt text-blue-500"></i> <?php echo e(__('messages.realtime_safety')); ?></div>
            <div class="flex items-center gap-1"><i class="fas fa-headset text-purple-500"></i> <?php echo e(__('messages.local_support_24_7')); ?></div>
          </div>
        </div>
          ...
          <div class="w-full max-w-md bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-5 shadow-2xl border border-white/40 backdrop-blur-sm">
            <div class="bg-white/80 rounded-2xl p-4 shadow-inner overflow-hidden relative">
              <div class="flex justify-between items-center border-b pb-2 mb-3">
                <span class="font-bold text-gray-700"><i class="fas fa-history text-blue-500 mr-2"></i> <?php echo e(__('messages.recent_checkins')); ?></span>
                <span class="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full" id="checkin-timer"><?php echo e(__('messages.live')); ?></span>
              </div>
  ...
  <div class="max-w-4xl mx-auto px-4 my-12">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
      <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
        <h2 class="text-2xl font-bold text-white flex items-center gap-2"><i class="fas fa-robot"></i> <?php echo e(__('messages.ai_travel_planner')); ?></h2>
        <p class="text-blue-100 text-sm"><?php echo e(__('messages.ai_travel_planner_desc')); ?></p>
      </div>
      <div class="p-6">
        <form id="itineraryForm" class="space-y-5">
          ...
          <div class="grid md:grid-cols-2 gap-5">
            <div>
              <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.destination')); ?> *</label>
              <input type="text" 
                     name="destination" 
                     id="destination" 
                     list="routeList" 
                     required 
                     placeholder="<?php echo e(__('messages.destination_placeholder')); ?>" 
                     class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500">
              <datalist id="routeList">
                <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($route->name); ?>"></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </datalist>
              <p class="text-xs text-gray-400 mt-1"><?php echo e(__('messages.destination_hint', ['count' => $routes->count()])); ?></p>
            </div>
            <div>
              <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.number_of_days')); ?> *</label>
              <input type="number" name="days" id="days" min="1" max="30" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
            </div>
            <div>
              <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.budget_usd')); ?> *</label>
              <input type="number" name="budget" id="budget" min="100" required placeholder="<?php echo e(__('messages.budget_placeholder')); ?>" class="w-full border border-gray-300 rounded-lg px-4 py-2">
            </div>
            <div>
              <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.travel_style')); ?> *</label>
              <select name="travel_style" id="travel_style" class="w-full border border-gray-300 rounded-lg px-4 py-2">
                <option value="budget"><?php echo e(__('messages.budget_travel')); ?></option>
                <option value="mid_range" selected><?php echo e(__('messages.mid_range')); ?></option>
                <option value="luxury"><?php echo e(__('messages.luxury')); ?></option>
                <option value="backpacker"><?php echo e(__('messages.backpacker')); ?></option>
              </select>
            </div>
          </div>
          <div>
            <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.your_interests')); ?></label>
            <textarea name="interests" id="interests" rows="2" placeholder="<?php echo e(__('messages.interests_placeholder')); ?>" class="w-full border border-gray-300 rounded-lg px-4 py-2"></textarea>
          </div>
          <div>
            <label class="block text-gray-700 font-semibold mb-1"><?php echo e(__('messages.fitness_level')); ?></label>
            <select name="fitness_level" id="fitness_level" class="w-full border border-gray-300 rounded-lg px-4 py-2">
              ...
              <option value="moderate" selected><?php echo e(__('messages.moderate')); ?></option>
          ...
          <button type="submit" id="generateBtn" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg transition flex items-center justify-center gap-2 shadow-md">
            <i class="fas fa-magic"></i> <?php echo e(__('messages.generate_itinerary')); ?>

          </button>
        </form>
        <div id="result" class="mt-8 hidden">
          <div class="flex flex-wrap justify-between items-center mb-3 gap-2">
            <h3 class="text-xl font-bold text-gray-800 flex items-center gap-2"><i class="fas fa-map-marked-alt text-blue-600"></i> <?php echo e(__('messages.your_personalized_itinerary')); ?></h3>
            <div class="flex gap-2">
              <button onclick="downloadItinerary()" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-1">
                <i class="fas fa-download"></i> <?php echo e(__('messages.download_txt')); ?>
              ...
              <button onclick="copyItinerary()" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-1">
                <i class="fas fa-copy"></i> <?php echo e(__('messages.copy')); ?>
...
<div class="bg-gray-50 border-y border-gray-100 py-6">
    <div class="max-w-7xl mx-auto px-6 flex flex-wrap justify-around gap-6 text-center">
      ...
      <div>
        <span class="text-3xl font-black text-blue-600"><?php echo e($stat['value']); ?></span>
        <p class="text-xs text-gray-500">
          <?php if($stat['label'] == 'Tourism Services'): ?>
            <?php echo e(__('messages.tourism_services')); ?>

          <?php elseif($stat['label'] == 'Trusted Providers'): ?>
            <?php echo e(__('messages.trusted_providers')); ?>

          <?php elseif($stat['label'] == 'Happy Travelers'): ?>
            <?php echo e(__('messages.happy_travelers')); ?>

          <?php elseif($stat['label'] == 'Zero Commission'): ?>
            <?php echo e(__('messages.zero_commission')); ?>

          <?php elseif($stat['label'] == 'Smart Contracts Ready'): ?>
            <?php echo e(__('messages.smart_contracts_ready')); ?>
  ...
  <section id="services" class="py-20 px-6 md:px-10 max-w-7xl mx-auto">
    <div class="text-center max-w-2xl mx-auto mb-14">
      <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider bg-blue-50 px-3 py-1 rounded-full"><?php echo e(__('messages.explore_nepal')); ?></span>
      <h2 class="text-3xl md:text-4xl font-bold mt-4 text-gray-900"><?php echo e(__('messages.popular_treks_tours_hotels')); ?></h2>
      <p class="text-gray-500 mt-3"><?php echo e(__('messages.handpicked_adventures')); ?></p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition border border-gray-100">
        <div class="h-48 bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center">
          <?php if($service->cover_image): ?>
            <img src="<?php echo e(asset('storage/' . $service->cover_image)); ?>" class="w-full h-full object-cover">
          <?php else: ?>
        ...
        <div class="p-5">
          ...
          <div class="flex flex-wrap gap-2 mt-2 text-sm text-gray-500">
            <span><i class="far fa-calendar-alt"></i> <?php echo e($service->trekDetail->duration_days ?? __('messages.na')); ?> <?php echo e(__('messages.days')); ?></span>
            <?php if($service->trekDetail): ?>
              <span><i class="fas fa-chart-line"></i> <?php echo e(ucfirst($service->trekDetail->difficulty)); ?></span>
            <?php endif; ?>
            <span><i class="fas fa-tag"></i> <?php echo e($service->category->name ?? __('messages.na')); ?></span>
          </div>
          <p class="text-gray-600 text-sm mt-3"><?php echo e($service->provider->name ?? 'TravelAI Partner'); ?></p>
          <a href="<?php echo e(route('public.services.show', $service->slug)); ?>" 
      ...
      <div class="col-span-full text-center py-10 text-gray-500"><?php echo e(__('messages.no_services_available')); ?></div>
      <?php endif; ?>
    </div>
    <div class="text-center mt-12">
      <a href="<?php echo e(route('public.services.index')); ?>" 
  ...
  <div class="max-w-7xl mx-auto px-4 py-12">
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
      <h2 class="text-3xl md:text-4xl font-bold mb-3"><?php echo e(__('messages.ready_to_scale')); ?></h2>
      <p class="text-blue-100 text-lg max-w-2xl mx-auto"><?php echo e(__('messages.choose_plan_text')); ?></p>
      <div class="flex flex-wrap justify-center gap-4 mt-6">
        <a href="<?php echo e(route('pages.pricing')); ?>" class="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-8 py-3 rounded-xl transition shadow-lg">
          <?php echo e(__('messages.view_pricing')); ?> →
        </a>
        <a href="<?php echo e(route('register')); ?>" class="bg-transparent border-2 border-white text-white hover:bg-white/10 font-semibold px-8 py-3 rounded-xl transition">
          <?php echo e(__('messages.get_started_free')); ?>
  ...
  <section id="features" class="py-20 px-6 md:px-10 max-w-7xl mx-auto">
    <div class="text-center max-w-2xl mx-auto mb-14">
      <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider bg-blue-50 px-3 py-1 rounded-full"><?php echo e(__('messages.core_intelligence')); ?></span>
      <h2 class="text-3xl md:text-4xl font-bold mt-4 text-gray-900"><?php echo e(__('messages.everything_need')); ?></h2>
      <p class="text-gray-500 mt-3"><?php echo e(__('messages.core_intelligence_desc')); ?></p>
    </div>
  ...
  <section id="workflow" class="bg-gray-50 py-20 px-6 md:px-10">
    <div class="max-w-7xl mx-auto">
      <div class="text-center max-w-2xl mx-auto mb-12">
        <span class="text-blue-600 font-semibold text-xs uppercase tracking-wide bg-blue-100 px-3 py-1 rounded-full"><?php echo e(__('messages.seamless_experience')); ?></span>
        <h2 class="text-3xl md:text-4xl font-bold mt-3 text-gray-900"><?php echo e(__('messages.simple_powerful_workflow')); ?></h2>
        <p class="text-gray-500 mt-2"><?php echo e(__('messages.for_trekkers_agencies')); ?></p>
      </div>
  ...
  <section id="agencies" class="py-20 px-6 md:px-10 max-w-7xl mx-auto">
    <div class="grid md:grid-cols-2 gap-12 items-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 md:p-12">
      <div>
        <span class="text-blue-700 font-semibold text-sm uppercase tracking-wider"><i class="fas fa-building"></i> <?php echo e(__('messages.for_travel_agencies')); ?></span>
        <h2 class="text-3xl md:text-4xl font-bold mt-2 text-gray-900"><?php echo e(__('messages.supercharge_business')); ?></h2>
        <p class="text-gray-700 mt-4 leading-relaxed"><?php echo e(__('messages.supercharge_desc')); ?></p>
        <ul class="mt-6 space-y-3">
          <li class="flex gap-2 items-start"><i class="fas fa-check-circle text-green-500 mt-1"></i><span><?php echo e(__('messages.supercharge_bullet1')); ?></span></li>
          <li class="flex gap-2 items-start"><i class="fas fa-check-circle text-green-500 mt-1"></i><span><?php echo e(__('messages.supercharge_bullet2')); ?></span></li>
          <li class="flex gap-2 items-start"><i class="fas fa-check-circle text-green-500 mt-1"></i><span><?php echo e(__('messages.supercharge_bullet3')); ?></span></li>
        </ul>
        <div class="mt-8 flex items-center gap-3"><i class="fas fa-chart-line text-2xl text-blue-600"></i><span class="text-sm font-medium text-gray-700"><?php echo e(__('messages.trusted_by_early')); ?></span></div>
      </div>
      <div class="bg-white/40 backdrop-blur-sm p-6 rounded-2xl border border-white shadow-lg">
        <div class="flex justify-between items-center border-b pb-3 mb-3"><span class="font-bold"><i class="fas fa-calendar-alt text-blue-500 mr-2"></i> <?php echo e(__('messages.today_dashboard')); ?></span><span class="text-xs bg-green-100 px-2 py-0.5 rounded-full"><?php echo e(__('messages.efficiency_plus')); ?></span></div>
        <div class="space-y-3 text-sm">
          <div class="flex justify-between"><span>📊 <?php echo e(__('messages.active_treks')); ?></span><span class="font-semibold">18</span></div>
          <div class="flex justify-between"><span>🧾 <?php echo e(__('messages.permits_issued')); ?></span><span class="font-semibold">46</span></div>
          <div class="flex justify-between"><span>📈 <?php echo e(__('messages.ai_revenue_forecast')); ?></span><span class="font-semibold text-green-600">+22%</span></div>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2 mt-2"><div class="bg-blue-600 h-2 rounded-full" style="width: 75%"></div></div>
        <p class="text-xs text-gray-500 mt-3"><?php echo e(__('messages.less_paperwork')); ?></p>
        <div class="mt-5 text-center text-xs text-gray-500"><i class="fas fa-lock"></i> <?php echo e(__('messages.zero_commission_smart_contract')); ?></div>
      </div>
    </div>
  </section>
  ...
  <section id="early-access" class="py-20 px-6 bg-gray-900 text-white relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
      ...
      <h2 class="text-3xl md:text-5xl font-extrabold"><?php echo e(__('messages.ready_to_transform')); ?></h2>
      <p class="text-gray-300 text-lg mt-4 max-w-2xl mx-auto"><?php echo e(__('messages.waitlist_text')); ?></p>
      <form class="mt-8 flex flex-col sm:flex-row gap-3 max-w-lg mx-auto" action="#">
        <?php echo csrf_field(); ?>
        <input type="email" required placeholder="<?php echo e(__('messages.email_placeholder')); ?>" class="flex-1 px-5 py-3 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 border-0">
        <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2"><i class="fas fa-rocket"></i> <?php echo e(__('messages.reserve_early_spot')); ?></button>
      </form>
      <p class="text-gray-400 text-xs mt-4"><?php echo e(__('messages.no_spam')); ?></p>
    </div>
  </section>
  ...
  <script>
    // ========== Translation Helper ==========
    const trans = {
      ai_trip_planner: "<?php echo e(__('messages.ai_trip_planner')); ?>",
      digital_trek_passport: "<?php echo e(__('messages.digital_trek_passport')); ?>",
      offline_emergency_sos: "<?php echo e(__('messages.offline_emergency_sos')); ?>",
      agency_dashboard: "<?php echo e(__('messages.agency_dashboard')); ?>",
      trek_memory_replay: "<?php echo e(__('messages.trek_memory_replay')); ?>",
      smart_permits_blockchain: "<?php echo e(__('messages.smart_permits_blockchain')); ?>",
      coming_2026_label: "<?php echo e(__('messages.coming_2026_label')); ?>",
      immutable_instant: "<?php echo e(__('messages.immutable_instant')); ?>",
      pwa_offline: "<?php echo e(__('messages.pwa_offline')); ?>",
      realtime_safety_score: "<?php echo e(__('messages.realtime_safety_score')); ?>",
      multilingual: "<?php echo e(__('messages.multilingual')); ?>",
      ai_generates_trek: "<?php echo e(__('messages.ai_generates_trek')); ?>",
      digital_qr_passport: "<?php echo e(__('messages.digital_qr_passport')); ?>",
      safe_trek_memories: "<?php echo e(__('messages.safe_trek_memories')); ?>",
      ai_trip_planner_desc: "<?php echo e(__('messages.ai_trip_planner_desc')); ?>",
      digital_trek_passport_desc: "<?php echo e(__('messages.digital_trek_passport_desc')); ?>",
      offline_emergency_sos_desc: "<?php echo e(__('messages.offline_emergency_sos_desc')); ?>",
      agency_dashboard_desc: "<?php echo e(__('messages.agency_dashboard_desc')); ?>",
      trek_memory_replay_desc: "<?php echo e(__('messages.trek_memory_replay_desc')); ?>",
      smart_permits_blockchain_desc: "<?php echo e(__('messages.smart_permits_blockchain_desc')); ?>",
      smart_recommendations: "<?php echo e(__('messages.smart_recommendations')); ?>",
      dynamic_pricing: "<?php echo e(__('messages.dynamic_pricing')); ?>",
      response_within_5min: "<?php echo e(__('messages.response_within_5min')); ?>",
      workflow_step1_desc: "<?php echo e(__('messages.workflow_step1_desc')); ?>",
      workflow_step2_desc: "<?php echo e(__('messages.workflow_step2_desc')); ?>",
      workflow_step3_desc: "<?php echo e(__('messages.workflow_step3_desc')); ?>",
    };
  ...
  <script>
    ...
    function renderItinerary(days, totalCost, breakdown, currency) {
      if (!days || days.length === 0) return '<p class="text-gray-500"><?php echo e(__('messages.no_itinerary')); ?></p>';
      ...
      if (breakdown && Object.keys(breakdown).length > 0) {
        ...
        html += `<p class="text-lg font-bold text-blue-800">💰 <?php echo e(__('messages.estimated_cost_breakdown')); ?> (${currency || 'NPR'})</p>`;
    ...
    continue;
        ...
        html += `</ul>`;
        html += `<p class="text-xs text-gray-400 mt-2">* <?php echo e(__('messages.cost_breakdown_note')); ?></p>`;
        html += `</div>`;
      } else if (totalCost && totalCost > 0) {
        const usdTotal = Math.round(totalCost * 0.0075);
        html += `<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">`;
        html += `<p class="text-lg font-bold text-blue-800">💰 <?php echo e(__('messages.estimated_base_cost')); ?>: <span class="text-2xl">~$${usdTotal} USD</span></p>`;
        html += `<p class="text-xs text-gray-400 mt-1"><?php echo e(__('messages.base_cost_note')); ?></p>`;
        html += `</div>`;
      }
      ...
      days.forEach(day => {
        ...
        html += `<h3 class="text-lg font-bold text-blue-700"><?php echo e(__('messages.day')); ?> ${day.day_number}: ${day.title}</h3>`;
        html += `<p class="text-gray-600 text-sm mt-1">${day.description || ''}</p>`;
        if (day.distance_km) html += `<p class="text-xs text-gray-400 mt-1">📏 ${day.distance_km} km  |  ⛰️ ${day.altitude_m || '<?php echo e(__('messages.na')); ?>'} m</p>`;
        if (day.items && day.items.length > 0) {
          ...
          day.items.forEach(item => {
            ...
            if (item.service_id && breakdown) {
              ...
              if (service) {
                const providerName = service.provider_name || '<?php echo e(__('messages.local_partner')); ?>';
                const serviceName = service.name || '<?php echo e(__('messages.service')); ?>';
    ...
    document.getElementById('itineraryForm').addEventListener('submit', async function(e) {
      ...
      btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> <?php echo e(__('messages.generating')); ?>';
      btn.disabled = true;
      ...
      try {
        ...
        if (data.success && data.data && data.data.days) {
          ...
          alert(data.message || '<?php echo e(__('messages.something_wrong')); ?>');
        }
      } catch (error) {
        console.error(error);
        alert('<?php echo e(__('messages.server_error')); ?>');
      } finally {
    ...
    function copyItinerary() {
      ...
      navigator.clipboard.writeText(text).then(() => {
        alert('<?php echo e(__('messages.copied_to_clipboard')); ?>');
      }).catch(() => {
        alert('<?php echo e(__('messages.copy_failed')); ?>');
      });
    }
...
if (userEmail) document.getElementById('travelerEmail').value = userEmail;
  ...
  <script>
    const checkins = <?php echo json_encode($recentCheckins, 15, 512) ?>;
    const anonymizedCheckins = checkins.map(item => ({ ...item, trekker_name: '<?php echo e(__('messages.anonymous')); ?>' }));
    ...
    function renderCheckin(index) {
      ...
      else slider.style.backgroundImage = `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('<?php echo e(asset("images/default-mountain.jpg")); ?>')`;
    ...
    else { const slider = document.getElementById('checkin-slider'); slider.innerHTML = '<div class="text-center text-gray-500"><?php echo e(__('messages.no_checkins_yet')); ?></div>'; slider.style.backgroundImage = ''; }
  </script>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function autoFill() {
        ...
        const routesData = <?php echo json_encode($routes->map(function($r) {
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TravelAI-Nepal\resources\views/home.blade.php ENDPATH**/ ?>