...
@section('title', 'Invoices | Provider Dashboard')
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <a href="{{ route('provider.invoices.show', $invoice) }}" class="text-blue-600 hover:underline text-sm">View</a>
                        <a href="{{ route('provider.invoices.download', $invoice) }}" class="text-green-600 hover:underline text-sm ml-2">Download</a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="px-4 py-8 text-center text-gray-500">No invoices found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
