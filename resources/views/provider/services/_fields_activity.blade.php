{{-- Phase 4M-2-3+4: Activity category fields --}}
@php $detail = $service?->activityDetail; @endphp

<div id="fields-activity" class="category-fields hidden space-y-4" data-slug="activity">
